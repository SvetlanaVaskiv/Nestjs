...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "user@mail.com", description: "Your email" }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, unique: true, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "141641651", description: "Password" }),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.STRING, allowNull: false }),
    __metadata("design:type", String)
], User.prototype, "password", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: "true", description: "User is banned or not" }),
...
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => roles_models_1.Role, () => user_roles_model_1.UserRoles),
